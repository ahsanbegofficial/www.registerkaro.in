  ...
  return (
    <div className='virtual-office'>
      ...
      <div className='importance-section'>
        <div className='left'>
          <h2>Importance of Virtual Office in Bangalore</h2>
          <div className='parent-div'>
            ...
            <div className='divs'>
              ...
              <h3>Flexibility</h3>
              <p>Virtual offices in Bangalore offer unique flexibility allowing businesses to operate from anywhere. This flexibility is most crucial for startups, freelancers, and small businesses with limited resources to sign a long-term lease or purchase their own office.</p>
            </div>
            <div className='divs'>
        ...
        <div className='parent-div'>
          <div className='card'>
            <div className="card-header">
              ...
              <p>Establish your company in Bangalore seamlessly with a Virtual Office Address, offering complete documentation, a prestigious location, and comprehensive in-office services.</p>
            </div>
          ...
          <div className='card'>
            <div className="card-header">
              ...
              <p>Obtain a GST number in Bangalore through a Virtual Office Address. Benefit from essential documentation, including NOC, Agreement, Signage, and Electricity Bill.</p>
            </div>
            <div className="body height-auto">
          ...
          <div className='card'>
            <div className="card-header">
              ...
              <p>Streamline courier handling with a Virtual Office Space, providing a prestigious business address for mailing purposes at different locations in Bangalore.</p>
            </div>
            <div className="body height-auto">
              <p><Image src={tick} alt={'image'} height={20} width={20} />Use the Address as your Mailing Address.</p>
      ...
      <div className="experience">
        ...
        <div className='parent-div'>
          <div className='divs'>
            ...
            <p>Enjoy the lowest price as compared to any other virtual office service providers in Bangalore.</p>
          </div>
          <div className='divs'>
      ...
      <div className="kyc">
        <h2>Documents for <span className="bold">Business Registration or GST Registration Plan</span> in Bangalore</h2>
        <table>
          <tr>
