...
const Home = () => {
    ...
    const cityFromQuery = query?.replace('partnership-firm-registration-in-', '');
    ...
    return (
        <div className='services-pages partnership-firm-reg'>
            ...
            <h1 className='main-heading'>Online Partnership Firm Registration in {cityName}</h1>
            <div className='heading-line'></div>
            <Process cityName={cityName} />
            <h2 className='main-heading'>What is a Partnership?</h2>
            <div className='heading-line'></div>
            <WhatIs cityName={cityName} />
            <h2 className='main-heading'>Importance of Registering a Partnership Firm in {cityName}</h2>
            <div className='heading-line'></div>
            <Benefits cityName={cityName} />
            <h2 className='main-heading'>Advantages of Partnership Firm Registration</h2>
            <div className='heading-line'></div>
            <Advantages cityName={cityName} />
            <h2 className='main-heading'>Disadvantages of Partnership Firm Registration</h2>
            <div className='heading-line'></div>
            <Disdvantages cityName={cityName} />
            <h2 className='main-heading'>Checklist for Partnership Firm Registration in {cityName}</h2>
            <div className='heading-line'></div>
            <Checklist cityName={cityName} />
            <h2 className='main-heading'>Documents for Partnership Firm Registration in {cityName}</h2>
            <div className='heading-line'></div>
            <DocumentsForPartnership cityName={cityName} />
            <h2 className='main-heading'>What is a Partnership Deed?</h2>
            <div className='heading-line'></div>
            <PartnershipDeed cityName={cityName} />
            <h2 className='main-heading'>Procedure for Partnership Firm Registration in {cityName}</h2>
            <div className='heading-line'></div>
            <ProcedureForPartnership cityName={cityName} />
            <h2 className='main-heading'>Timeline for Partnership Firm Registration</h2>
            <div className='heading-line'></div>
            <TimeLine cityName={cityName} />
            <h2 className='main-heading'>Compliance after getting Partnership Firm Registration Online</h2>
            <div className='heading-line'></div>
            ...
            <RegistrationLinks formattedQuery={'Partnership Firm Registration'} state={state} Query={'partnership-firm-registration'} city={city} />
        </div>
    )
}
export default Home