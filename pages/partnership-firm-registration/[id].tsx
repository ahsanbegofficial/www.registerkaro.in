...
const Home = () => {
    ...
    return (
        <div className='services-pages partnership-firm-reg'>
            ...
            <h1 className='main-heading'>Importance of Registering a Partnership Firm in {cityName}</h1>
            <div className='heading-line'></div>
            ...
            <h1 className='main-heading'>Checklist for Partnership Firm Registration in {cityName}</h1>
            <div className='heading-line'></div>
            <Checklist cityName={cityName} />
            <h1 className='main-heading'>Documents for Partnership Firm Registration in {cityName}</h1>
            <div className='heading-line'></div>
            ...
            <h1 className='main-heading'>Procedure for Partnership Firm Registration in {cityName}</h1>
            <div className='heading-line'></div>
