    ...
    return (
        <div className='services-pages msme-registration-reg'>
            <Head>
                ...
                <link rel="canonical" href="https://www.registerkaro.in/msme-registration-online" />
                <link rel="icon" href="/favicon.ico" />
                <meta property="og:title" content="MSME Registration Online | RegisterKaro" />
            ...
            <h2 className='main-heading'>What are MSMEs?</h2>
            <div className='heading-line'></div>
            <WhatMSME cityName={'India'} />
            <h2 className='main-heading'>What type of business comes under MSME? </h2>
            <div className='heading-line'></div>
            <TypeBusiness cityName={'India'} />
            <h2 className='main-heading'>MSME Classification</h2>
            <div className='heading-line'></div>
            <TableCom cityName={'India'} />
            <h2 className='main-heading'>Benefits of MSME Registration Online</h2>
            <div className='heading-line'></div>
            <BenefitsMSME cityName={'India'} />
            <h2 className='main-heading'>What is Udyam Registration?</h2>
            <div className='heading-line'></div>
            <UdyamRegistration cityName={'India'} />
            <h2 className='main-heading'>What is the difference between MSME and Udyam Registration?</h2>
            <div className='heading-line'></div>
            <UdyamDiffrence cityName={'India'} />
            <h2 className='main-heading'>Which Entities are eligible for MSME Online?</h2>
            <div className='heading-line'></div>
            <WhichEntities cityName={'India'} />
            <h2 className='main-heading'>Supporting Documents Required for MSME Registration Online</h2>
            <div className='heading-line'></div>
            <SupportingDocuments cityName={'India'} />
            <h2 className='main-heading'>Process for MSME Registration Online</h2>
            <div className='heading-line'></div>
            <ProcessMSME cityName={'India'} />
            <h2 className='main-heading'>No Fee for Registration</h2>
            <div className='heading-line'></div>
            <NoFee cityName={'India'} />
