...
const Home = () => {
  return (
    <div className="services-pages iec-registration-reg">
      ...
      <h2 className="main-heading">Benefits of IEC Registration in India</h2>
      <div className="heading-line"></div>
      <AdvantagesBIS cityName={'India'} />
      <h2 className="main-heading">What is the eligibility to get the Import Export Code in India?</h2>
      <div className="heading-line"></div>
      <Eligibility cityName={'India'} />
      <h2 className="main-heading">Prerequisites for applying IEC Code in India </h2>
      <div className="heading-line"></div>
