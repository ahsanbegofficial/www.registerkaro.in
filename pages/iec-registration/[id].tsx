...
const Home = () => {
  ...
  const cityFromQuery = query?.replace('iec-registration-in-', '');
  ...
  return (
    <div className="services-pages iec-registration-reg">
      ...
      <h1 className="main-heading">Online IEC Registration in {cityName}</h1>
      <div className="heading-line"></div>
      <Process cityName={cityName} />
      <h2 className="main-heading">When is Import Export Code Required?</h2>
      <div className="heading-line"></div>
      <ObjectivesChecklist cityName={cityName} />
      <h2 className="main-heading">Benefits of IEC Registration in {cityName}</h2>
      <div className="heading-line"></div>
      <AdvantagesBIS cityName={cityName} />
      <h2 className="main-heading">What is the eligibility to get the Import Export Code in {cityName}?</h2>
      <div className="heading-line"></div>
      <Eligibility cityName={cityName} />
      <h2 className="main-heading">Prerequisites for applying IEC Code in {cityName} </h2>
      <div className="heading-line"></div>
      <EventBased cityName={cityName} />
      <h2 className="main-heading">Documents Required for IEC Registration</h2>
      <div className="heading-line"></div>
      <DocsReq cityName={cityName} />
      <h2 className="main-heading">Procedure for IEC Registration Online</h2>
      <div className="heading-line"></div>
      <KeyInitiatives cityName={cityName} />
      <h2 className="main-heading">When is IEC not Mandatory?</h2>
      <div className="heading-line"></div>
      <PartnershipDeed cityName={cityName} />
      <h2 className="main-heading">Exemption of Import Export Code (IEC)</h2>
      <div className="heading-line"></div>
      <Exemption cityName={cityName} />
