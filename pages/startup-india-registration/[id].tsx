...
const Home = () => {
    ...
    return (
        <div className='services-pages startup-reg'>
            ...
            <h2 className="main-heading">Objectives of Startup {cityName} Movement</h2>
            <div className='heading-line'></div>
            <Objectives cityName={cityName} />
            <h2 className="main-heading">Benefits of Startup {cityName} Registration </h2>
            <div className='heading-line'></div>
            ...
            <h2 className="main-heading">Who is not eligible for Startup {cityName} Registration or Startup {cityName} Recognition?</h2>
            <div className='heading-line'></div>
            <Checklist cityName={cityName} />
            <h2 className="main-heading">Documents required for Startup {cityName} Company Registration</h2>
            <div className='heading-line'></div>
