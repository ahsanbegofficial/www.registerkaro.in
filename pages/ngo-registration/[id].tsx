...
const Home = () => {
    ...
    const cityFromQuery = query?.replace('ngo-registration-in-', '');
    ...
    return (
        <div className='services-pages ngo-reg'>
            ...
            <h1 className='main-heading'>Online NGO Registration in {cityName}</h1>
            <div className='heading-line'></div>
            <Process cityName={cityName} />
            <h2 className="main-heading">Types of NGO Registration in {cityName}</h2>
            <div className='heading-line'></div>
            <TypeOfNgo cityName={cityName} />
            <h2 className="main-heading">Difference Between Trust, Society, and Section 8 Company</h2>
            <div className='heading-line'></div>
            <TableCom cityName={cityName} />
            <h2 className='main-heading'>Classification of NGOs in {cityName}</h2>
            <div className='heading-line'></div>
            <Classification cityName={cityName} />
            <h2 className="main-heading">Why Is NGO Registration Required?</h2>
            <div className='heading-line'></div>
            <WhyNGO cityName={cityName} />
            <h2 className="main-heading">Benefits of NGO Registration</h2>
            <div className='heading-line'></div>
            <Benefits cityName={cityName} />
            <h2 className="main-heading">Eligibility to Start an NGO</h2>
            <div className='heading-line'></div>
            <Checklist cityName={cityName} />
            <h2 className="main-heading">NGO Registration Process</h2>
            <div className='heading-line'></div>
            <HowToRegister cityName={cityName} />
            <h2 className="main-heading">Registration Fees</h2>
            <div className='heading-line'></div>
            <RegiFee cityName={cityName} />
            <h2 className="main-heading">How to Raise Funds for NGOs?</h2>
            <div className='heading-line'></div>
            <HowToRaise cityName={cityName} />
