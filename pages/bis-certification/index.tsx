...
const Home = () => {
    return (
        <div className='services-pages bis-certification-reg'>
            ...
            <h2 className='main-heading'>Key Initiatives by BIS</h2>
            <div className='heading-line'></div>
            <KeyInitiatives cityName={'India'} />
            <h2 className='main-heading'>Objectives of BIS</h2>
            <div className='heading-line'></div>
            <ObjectivesChecklist cityName={'India'} />
            <h2 className='main-heading'>Quality Control Orders</h2>
            <div className='heading-line'></div>
            <PartnershipDeed cityName={'India'} />
            <h2 className='main-heading'>Advantages of Obtaining BIS Certification</h2>
            <div className='heading-line'></div>
            <AdvantagesBIS cityName={'India'} />
            <h2 className='main-heading'>Types of BIS Certification</h2>
            <div className='heading-line'></div>
            <EventBased cityName={'India'} />
            <h2 className='main-heading'>Products Covered Under BIS Certification</h2>
            <div className='heading-line'></div>
            <DocsREquired cityName={'India'} />
            <h2 className='main-heading'>Documentation Required for BIS Certification</h2>
            <div className='heading-line'></div>
            <OtherAnnual cityName={'India'} />
            <h2 className='main-heading'>Procedure for BIS Certification</h2>
            <div className='heading-line'></div>
