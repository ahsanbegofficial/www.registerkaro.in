...
let city = [
  ...
  "yamunanagar"
    ...
    const Home = () => {
      ...
      const cityFromQuery = query?.replace('bis-fmcs-certification-in-', '');
    ...
    return (
        <div className='services-pages bis-fmcs-certification-reg'>
            ...
            <h2 className='main-heading'>What is BIS Standard Mark?</h2>
            <div className='heading-line'></div>
            <KeyInitiatives cityName={cityName}/>
            <h2 className='main-heading'>Importance of BIS FMCS Certification in {cityName}</h2>
            <div className='heading-line'></div>
            <ObjectivesChecklist cityName={cityName}/>
            <h2 className='main-heading'>List of Products Which Require BIS FMCS Certification</h2>
            <div className='heading-line'></div>
            <DocsREquired cityName={cityName}/>
            <h2 className='main-heading'>Requirements for BIS FMCS Certification</h2>
            <div className='heading-line'></div>
            <EventBased cityName={cityName}/>
            <h2 className='main-heading'>Required Documents for BIS FMCS Certification</h2>
            <div className='heading-line'></div>
            <DocRequiredBIS cityName={cityName}/>
            <h2 className='main-heading'>Procedure for Obtaining BIS FMCS Certification</h2>
            <div className='heading-line'></div>
            <ProcedureObtaining cityName={cityName}/>
            <h2 className='main-heading'>Key Guidelines for Nomination of AIR (Authorized Indian Representative) for Foreign Manufacturers</h2>
            <div className='heading-line'></div>
