...
const Home = () => {
    ...
    const cityFromQuery = query?.replace('esi-registration-in-', '');
    ...
    return (
        <div className='services-pages esi-registration-reg'>
            <Head>
                ...
                <link rel="canonical" href="https://www.registerkaro.in/esi-registration" />
            ...
            <h1 className='main-heading'>Benefits of ESI Registration in {cityName}</h1>
            <div className='heading-line'></div>
            ...
            <h1 className='main-heading'>What is the Eligibility for ESI Registration in {cityName}?</h1>
            <div className='heading-line'></div>
            <OtherAnnual cityName={cityName}/>
            <h1 className='main-heading'>What are the vital documents required for online ESI Registration in {cityName}?</h1>
            <div className='heading-line'></div>
            ...
            <h1 className='main-heading'>Compliance and Returns after ESI Registration in {cityName}</h1>
            <div className='heading-line'></div>
