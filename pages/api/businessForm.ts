...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
    if (req.method === 'POST') {
        try {
            ...
            const formData = {
                'Proposed Name Of Business': bodyData['Proposed Name Of Business'],
                'Number of Partners': bodyData['Number of Partners'],
                'State of Incorporation': bodyData['State of Incorporation'],
                'Name': bodyData['Name'],
