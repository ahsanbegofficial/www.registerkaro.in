...
const Home = () => {
    ...
    const cityFromQuery = query?.replace('iso-certification-in-', '');
    ...
    return (
        <div className='services-pages iso-certification-reg'>
            ...
            <h2 className='main-heading'>ISO Framework & Controls</h2>
            <div className='heading-line'></div>
            <ISOFramework cityName={cityName} />
            <h2 className='main-heading'>What are the Different Types of ISO Standards in {cityName}?</h2>
            <div className='heading-line'></div>
            <DifferentTypes cityName={cityName} />
            <h2 className='main-heading'>Benefits of ISO Certification In {cityName}</h2>
            <div className='heading-line'></div>
            <BenefitsISO cityName={cityName} />
            <h2 className='main-heading'>Which ISO Certification is good for any business?</h2>
            <div className='heading-line'></div>
            <WhichISO cityName={cityName} />
            <h2 className='main-heading'>Documents Required for ISO Certification in {cityName}</h2>
            <div className='heading-line'></div>
            <DocumentsRequired cityName={cityName} />
            <h2 className='main-heading'>Procedure for Obtaining ISO Certification in {cityName}</h2>
            <div className='heading-line'></div>
            <Procedure cityName={cityName} />
            <h2 className='main-heading'>What is an ISO Audit and its types?</h2>
            <div className='heading-line'></div>
            <WhatISO cityName={cityName} />
