...
const Home = () => {
    return (
        <div className='services-pages iso-certification-reg'>
            ...
            <h2 className='main-heading'>What are the Different Types of ISO Standards in India?</h2>
            <div className='heading-line'></div>
            <DifferentTypes cityName={'India'} />
            <h2 className='main-heading'>Benefits of ISO Certification In India</h2>
            <div className='heading-line'></div>
            ...
            <h2 className='main-heading'>Documents Required for ISO Certification in India</h2>
            <div className='heading-line'></div>
            <DocumentsRequired cityName={'India'} />
            <h2 className='main-heading'>Procedure for Obtaining ISO Certification in India</h2>
            <div className='heading-line'></div>
