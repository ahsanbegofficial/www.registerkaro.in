...
const Home = () => {
    ...
    return (
        <div className='services-pages sole-reg'>
            ...
            <h1 className="main-heading">What types of businesses in {cityName} can be Sole Proprietorships?</h1>
            <div className='heading-line'></div>
            <WhatBusinessPro cityName={cityName} />
            <h1 className="main-heading">Benefits of Sole Proprietorship in {cityName}</h1>
            <div className='heading-line'></div>
            <Benefits cityName={cityName} />
            <h1 className="main-heading">Eligibility Criteria for Sole Proprietorship Registration in {cityName}</h1>
            <div className='heading-line'></div>
            <Eligibility cityName={cityName} />
            <h1 className="main-heading">Checklist for Sole Proprietorship Registration in {cityName}</h1>
            <div className='heading-line'></div>
            <Checklist cityName={cityName} />
            <h1 className="main-heading">Documents Required for Sole Proprietorship Registration in {cityName}</h1>
            <div className='heading-line'></div>
            <DocumentRequired cityName={cityName} />
            <h1 className="main-heading">Procedure for Sole Proprietorship Registration in {cityName}</h1>
            <div className='heading-line'></div>
            ...
            <h1 className="main-heading">Compliances for Sole Proprietorship in {cityName}</h1>
            <div className='heading-line'></div>
