...
const Home = () => {
    ...
    const cityFromQuery = query?.replace('sole-proprietorship-registration-in-', '');
    ...
    return (
        <div className='services-pages sole-reg'>
            ...
            <h1 className='main-heading'>Online Sole Proprietorship Registration in {cityName}</h1>
            <div className='heading-line'></div>
            <Process cityName={cityName} />
            <h2 className="main-heading">What types of businesses in {cityName} can be Sole Proprietorships?</h2>
            <div className='heading-line'></div>
            <WhatBusinessPro cityName={cityName} />
            <h2 className="main-heading">Benefits of Sole Proprietorship in {cityName}</h2>
            <div className='heading-line'></div>
            <Benefits cityName={cityName} />
            <h2 className="main-heading">Eligibility Criteria for Sole Proprietorship Registration in {cityName}</h2>
            <div className='heading-line'></div>
            <Eligibility cityName={cityName} />
            <h2 className="main-heading">Checklist for Sole Proprietorship Registration in {cityName}</h2>
            <div className='heading-line'></div>
            <Checklist cityName={cityName} />
            <h2 className="main-heading">Documents Required for Sole Proprietorship Registration in {cityName}</h2>
            <div className='heading-line'></div>
            <DocumentRequired cityName={cityName} />
            <h2 className="main-heading">Procedure for Sole Proprietorship Registration in {cityName}</h2>
            <div className='heading-line'></div>
            <Procedure cityName={cityName} />
            <h2 className="main-heading">Registering under the Shops & Establishments Act</h2>
            <div className='heading-line'></div>
            <RegisterUnderEstablishment cityName={cityName} />
            <h2 className="main-heading">Registering through GST Registration</h2>
            <div className='heading-line'></div>
            <RegisterGst cityName={cityName} />
            <h2 className="main-heading">Registration through Udyog or Udyam Aadhar Registration under MSME</h2>
            <div className='heading-line'></div>
            <RegisterUdyog cityName={cityName} />
            <h2 className="main-heading">Compliances for Sole Proprietorship in {cityName}</h2>
            <div className='heading-line'></div>
            <Compliances cityName={cityName} />
