...
const Home = () => {
    ...
    const cityFromQuery = query?.replace('virtual-office-in-', '');
    ...
    return (
        <div className='services-pages virtual-office-reg'>
            ...
            <h1 className='main-heading'>An Overview of Virtual Office in {cityName}</h1>
            <div className='heading-line'></div>
            <Process cityName={cityName} />
            <h2 className='main-heading'>Technology and Tools Driving Virtual Offices</h2>
            <div className='heading-line'></div>
            <Technology cityName={cityName} />
            <h2 className='main-heading'>Key Features of Virtual Office</h2>
            <div className='heading-line'></div>
            <Features cityName={cityName} />
            <h2 className='main-heading'>Benefits of Virtual Office</h2>
            <div className='heading-line'></div>
            <Benefits cityName={cityName} />
            <h2 className='main-heading'>Drawbacks of Virtual Office</h2>
            <div className='heading-line'></div>
            <Drawbacks cityName={cityName} />
            <h2 className='main-heading'>Impact of Virtual Offices on Company Culture</h2>
            <div className='heading-line'></div>
            <Impact cityName={cityName} />
            <h2 className='main-heading'>Future Trends and Adaptation of Virtual Offices</h2>
            <div className='heading-line'></div>
            <Future cityName={cityName} />
            <h2 className='main-heading'>Costs of Virtual Offices</h2>
            <div className='heading-line'></div>
            <Cost cityName={cityName} />
            <h2 className='main-heading'>Laws/Acts relating to Virtual Offices</h2>
            <div className='heading-line'></div>
            <Laws cityName={cityName} />
