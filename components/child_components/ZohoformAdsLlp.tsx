const ZohoformAdsPvt:React.FC = () => {
	const ZohoformAdsPvtCode = `
	  <div class="zf-templateWidth"><form action='https://forms.zohopublic.in/safeledgerprivatelimited/form/LLPAds2023NewWebsite/formperma/_w0r24EBRYWgdktJFgY4qn_p-rA1SK1WT3qkKZe5TkM/htmlRecords/submit' name='form' method='POST' accept-charset='UTF-8' enctype='multipart/form-data' id='form'>
  ...
  <div class="zf-tempContDiv">
  <select  class="zf-form-sBox" name="Dropdown" checktype="c1" required>
  <option class='drpdwn' value="">-Number of Partners-</option>
...
<li class="zf-tempFrmWrapper zf-large">
<div class="zf-tempContDiv">
<span> <input type="text" name="SingleLine1" checktype="c1" value="" maxlength="255" fieldType=1 placeholder="Message"/></span> <p id="SingleLine1_error" class="zf-errorMessage" style="display:none;">Invalid value</p>
</div><div class="zf-clearBoth"></div></li><!---------Single Line Ends Here---------->
  
  </ul></div><!---------template Container Starts Here---------->
  <ul><li class="zf-fmFooter"><button class="zf-submitColor" >Get a Detailed Quotation Now!</button></li></ul></div><!-- 'zf-templateWrapper' ends --></form></div>
  
  
  <script>
  var zf_DateRegex = new RegExp("^(([0][1-9])|([1-2][0-9])|([3][0-1]))[-](Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec|JAN|FEB|MAR|APR|MAY|JUN|JUL|AUG|SEP|OCT|NOV|DEC)[-](?:(?:19|20)[0-9]{2})$");
  var zf_MandArray = [ "SingleLine", "Email", "PhoneNumber_countrycode", "PhoneNumber_countrycodeVal", "Dropdown"]; 
  var zf_FieldArray = [ "SingleLine", "Email", "PhoneNumber_countrycode", "PhoneNumber_countrycodeVal", "Dropdown","SingleLine1"]; 
  ...
  input, input[type="text"],input[type="email"], input[type="search"], isindex, textarea, button {
	  outline:none;
	  margin:0 auto;
	  padding:5px 10px;
  ...
  .note .zf-descFld{
	...
	return (
	  <form>
		<div dangerouslySetInnerHTML={{ __html: ZohoformAdsPvtCode }} />
	  </form>
	);
  };
  
  export default ZohoformAdsPvt;
