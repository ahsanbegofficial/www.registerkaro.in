const ZohoformAdsPublic: React.FC = () => {
	const ZohoformAdsPublicCode = `
	  <div class="zf-templateWidth"><form action='https://forms.zohopublic.in/safeledgerprivatelimited/form/PublicLimitedAds2023V2/formperma/L0amd_EHhOuJyhXhzZBgEvGnKj-D3TSnnceDIATy35k/htmlRecords/submit' name='form' method='POST' accept-charset='UTF-8' enctype='multipart/form-data' id='form'>
  ...
  <!---------input Starts Here---------->
  <input  type="text" name="SingleLine1" class='display-none' value="" fieldType=1 maxlength="255" placeholder="" />
  <!---------input Ends Here---------->
  ...
  var zf_MandArray = [ "SingleLine", "Email", "PhoneNumber_countrycode", "PhoneNumber_countrycodeVal"]; 
  ...
  .padding-0{
	...
	return (
		<form>
			<div dangerouslySetInnerHTML={{ __html: ZohoformAdsPublicCode }} />
		</form>
	);
};

export default ZohoformAdsPublic;
