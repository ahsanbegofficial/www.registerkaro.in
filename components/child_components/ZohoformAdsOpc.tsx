const ZohoformAdsOpc:React.FC = () => {
  const ZohoformAdsOpcCode = `
    <div class="zf-templateWidth"><form action='https://forms.zohopublic.in/safeledgerprivatelimited/form/OPCAds2023V2/formperma/hAglpxr8DS9NwQRHwDkP81roYHqEzfXL37UjYGv_bQk/htmlRecords/submit' name='form' method='POST' accept-charset='UTF-8' enctype='multipart/form-data' id='form'>
...
.note .zf-descFld{
  ...
  return (
    <form>
      <div dangerouslySetInnerHTML={{ __html: ZohoformAdsOpcCode }} />
    </form>
  );
};

export default ZohoformAdsOpc;
