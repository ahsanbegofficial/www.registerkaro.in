const ZohoformAdsProducer:React.FC = () => {
  const ZohoformAdsProducerCode = `
    <div class="zf-templateWidth"><form action='https://forms.zohopublic.in/safeledgerprivatelimited/form/ProducerCompanyAds2023NewWebsite/formperma/ejC9W06DdIarpjddvA6-pD01JFV1QZxSbD6TrEvIWZA/htmlRecords/submit' name='form' method='POST' accept-charset='UTF-8' enctype='multipart/form-data' id='form'>
...
<option class='drpdwn' value="">-State-</option>
...
var zf_FieldArray = [ "SingleLine", "Email", "PhoneNumber_countrycode", "PhoneNumber_countrycodeVal", "Dropdown"]; 
...
.note .zf-descFld{
  ...
  return (
    <form>
      <div dangerouslySetInnerHTML={{ __html: ZohoformAdsProducerCode }} />
    </form>
  );
};

export default ZohoformAdsProducer;
