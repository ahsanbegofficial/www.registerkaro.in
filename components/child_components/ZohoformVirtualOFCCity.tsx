interface ZohoformVirtualOFCCityProps {
	Query: any;
}

const ZohoformVirtualOFCCity:React.FC<ZohoformVirtualOFCCityProps> = ({Query}) => {
	const zohoFormCode = `
	<div class="zf-templateWidth"><form action='https://forms.zohopublic.in/safeledgerprivatelimited/form/VirtualOfficeDynamicAds2023/formperma/GZ1Ze1SskAKjdC5B00EDbsiXjwMa6DzJ01y2sFbXkO4/htmlRecords/submit' name='form' method='POST' accept-charset='UTF-8' enctype='multipart/form-data' id='form'>
...
<!---------input Starts Here---------->
<input  type="text" name="SingleLine1" class='display-none' value='Virtual office in ${Query}' fieldType=1 maxlength="255" placeholder="" />
<!---------input Ends Here---------->
...
export default ZohoformVirtualOFCCity;