const ZohoformAdsNidhi: React.FC = () => {
	const ZohoformAdsNidhiCode = `
	  <div class="zf-templateWidth"><form action='https://forms.zohopublic.in/safeledgerprivatelimited/form/NidhiAds2023NewWebsite/formperma/DJ4kaF2GSkpVzizB4dl55tdXyEFTs57bL-ix5Z6JDJY/htmlRecords/submit' name='form' method='POST' accept-charset='UTF-8' enctype='multipart/form-data' id='form'>
  ...
  .note .zf-descFld{
	...
	return (
		<form>
			<div dangerouslySetInnerHTML={{ __html: ZohoformAdsNidhiCode }} />
		</form>
	);
};

export default ZohoformAdsNidhi;
