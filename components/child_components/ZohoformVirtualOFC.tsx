const ZohoformVirtualOFC:React.FC = () => {
  const zohoFormCode = `
    <div class="zf-templateWidth"><form action='https://forms.zohopublic.in/safeledgerprivatelimited/form/VirtualOfficeBangaloreAds2023/formperma/szV7MjG-mq2y-pR6VpgcMW1HU2134ZVHKmbJpVuazfE/htmlRecords/submit' name='form' method='POST' accept-charset='UTF-8' enctype='multipart/form-data' id='form'>
...
export default ZohoformVirtualOFC;