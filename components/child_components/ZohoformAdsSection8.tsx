const ZohoformAdsSection8:React.FC = () => {
  const ZohoformAdsSection8Code = `
    <div class="zf-templateWidth"><form action='https://forms.zohopublic.in/safeledgerprivatelimited/form/Section8Ads2023NewWebsite/formperma/hKjGb2yyQdGWsGwKrZe2wIjBIMIkfBbT29ugxkYbM58/htmlRecords/submit' name='form' method='POST' accept-charset='UTF-8' enctype='multipart/form-data' id='form'>
...
.note .zf-descFld{
  ...
  return (
    <form>
      <div dangerouslySetInnerHTML={{ __html: ZohoformAdsSection8Code }} />
    </form>
  );
};

export default ZohoformAdsSection8;
