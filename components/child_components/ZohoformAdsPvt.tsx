const ZohoformAdsPvt:React.FC = () => {
  const ZohoformAdsPvtCode = `
    <div class="zf-templateWidth"><form action='https://forms.zohopublic.in/safeledgerprivatelimited/form/PrivateLimitedAds2023V2/formperma/mCsWHxBXzkV5v5e4I4sT2w1I69sx05UPTBjqMaMmzPQ/htmlRecords/submit' name='form' method='POST' accept-charset='UTF-8' enctype='multipart/form-data' id='form'>
