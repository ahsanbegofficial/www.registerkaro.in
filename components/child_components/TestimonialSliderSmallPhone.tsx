...
const TestimonialSliderSmallPhone: React.FC<TestimonialSliderProps> = ({ review }) => {
  const swiperSlides = useMemo( () =>
      review?.map((blogData) => (
        <SwiperSlide key={blogData.id}>
          <div className="testimonial__slide__content grabbed flex-test-phone">
...
export default TestimonialSliderSmallPhone;