...
const ZohoFormService: React.FC<ZohoFormServiceProps> = ({ service }) => {
  ...
  <span> 
  <input type="text" compname="PhoneNumber" name="PhoneNumber_countrycode" maxlength="15" checktype="c7" value="" phoneFormat="1" isCountryCodeEnabled=true fieldType="11" id="international_PhoneNumber_countrycode" valType="number" phoneFormatType="1" placeholder="Mobile Number" value='' required/>
  <label></label> </span>
