    ...
    <div className='DocumentRequired flex w-80 m-auto mobile-flex-column' id='Eligibility'>
      ...
      <div className='flex-6'>
        ...
        <ul className='tick list-unstyled'>
          <li><Image alt="At least 1 Director is required and he or she should be a resident of India" className="ulArrow-img" loading="lazy" height={30} width={30} src={ulArrow} /> At least 1 Director is required and he or she should be a resident of India</li>
          <li><Image alt="HUF, an individual is eligible to commence a Section 8 Company in India" className="ulArrow-img" loading="lazy" height={30} width={30} src={ulArrow} /> HUF, an individual is eligible to commence a Section 8 Company in India</li>
