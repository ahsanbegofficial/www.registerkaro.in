  ...
  return (
    <div className='benefits flex w-80 m-auto mobile-flex-column' id='Benefits'>
       <div className='flex-5'>
          <Image alt="The benefits of Sole Proprietorship in India and these are Ease of Dissolution, Very Less Compliance, Sole Beneficiary of Profits, Quick Decision, Complete Control over the Business" className="benefits-img w-100" height={980} loading="lazy" src={bft} />
      </div>
      <div className='flex-5'>
        <p>The following are the benefits of Sole Proprietorship in { cityName }:</p>
        <p><strong>1. Ease of Dissolution:</strong></p>
        <p>Just like it is easy to start a Sole Proprietorship in { cityName }, you can also easily dissolve, sell, or terminate the same because you aren’t required to fulfil any legal formalities like obtaining TDS. Moreover, you can easily sell the assets of the Sole Proprietorship Company or Firm to a person or an association.</p>
        ...
        <p>One of the main advantages of a Sole Proprietorship is that the owner of the proprietorship is entitled to all the profits getting from the business. Unlike other business structures in { cityName } where profits are shared among shareholders or partners, the Proprietor retains complete ownership.</p>
