  ...
  return (
    <div className='DocumentArrowWise flex w-80 m-auto mobile-flex-column-reverse' id='Required'>
      <div className='flex-7'>
        ...
        <ul className='tick list-unstyled'>
          <li><Image alt="Rental agreement in English, digitally transcribed" className="ulArrow-img" loading="lazy" height={30} width={30} src={ulArrow} />Tenants are frequently given hard copies of rental agreements. This must be scanned and submitted to the appropriate authority for documentation.</li>
        </ul>
