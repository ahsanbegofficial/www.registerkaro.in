...
export const OPCReg = ({ cityName }: HeroProps) => {
  return (
    <div className='opcReg flex w-80 m-auto mobile-flex-column-reverse' id='Features'>
      <div className='flex-7'>
        <p>Following are some important features of One Person Company in {cityName}:</p>
      ...
      <div className='flex-3'>
        <Image alt="some important features of One Person Company in {cityName}" className="opcReg-img w-100" height={582} loading="lazy" src={pvtReg}/>
      </div>
    </div>
  )
}