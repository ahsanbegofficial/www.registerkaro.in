  ...
  return (
    <div className='benefits flex w-80 m-auto mobile-flex-column' id='Benefits'>
      <div className='flex-5'>
        <Image alt="Five primary benefits of online LLP Registration in {cityName}" className="benefits-img w-100" height={970} loading="lazy" src={benefit} />
      </div>
      <div className='flex-5'>
        <p>The following are the benefits of LLP Registration in {cityName}:</p>
        <p><strong>1. Low Cost and Less Compliance:</strong></p>
        <p>The overall cost of establishing a Limited Liability Partnership is low compared to the cost of registering a Private or Public Limited Company in {cityName}. The compliances to be followed by the LLP are also low. The LLP needs to file only 2 Statements yearly (i.e., an Annual Return and a Statement of Accounts and Solvency.</p>
        ...
        <p>For the LLP formation in {cityName}, no minimum capital is required. No minimum capital contribution is required from partners. An LLP can be incorporated even with Rs. 2000 as a total capital contribution.</p>
      </div>
    </div>
  )
}
