    ...
    <div >
      ...
      <div className='DocumentArrowWise flex w-80 m-auto mobile-flex-column-reverse'>
        ...
        <div className='flex-4 justify-content-center'>
          <Image alt="Types of business structures in india and these structures are private limited company, public limited company, one person company, limited and sole proprietorship" className="PartnershipDeed-img w-100" height={750} loading="lazy" src={dft} />
        </div>
      </div>
    </div>
  )
