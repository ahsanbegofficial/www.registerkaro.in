    ...
    <div id='WhoReq'>
      ...
      <div className='benefits flex w-80 m-auto mobile-flex-column mt-5' >
        <div className='flex-4'>
          <Image alt="The benefits of private limited company in india and these are Separate Legal Entity, Ease in Raising Funds, Limited Liability, Easy Transferable, Limited Liability and ESOP" className="WhoReq-img w-100" height={750} loading="lazy" src={bft} />
        </div>
