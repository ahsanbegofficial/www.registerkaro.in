          ...
          <div className="footer-medium text-white">
            <div>
              <div className="social">
                <Link href="https://m.facebook.com/profile.php?id=100067890646061&_rdr" target="_blank" className="social-icons1_link w-inline-block">
                ...
                <Link href="https://www.instagram.com/registerkaro_/" target="_blank" className="social-icons1_link w-inline-block">
                  <div className="social-icon-2 w-embed">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <Link href="https://mobile.twitter.com/registerkaro" target="_blank" className="social-icons1_link w-inline-block">
                  <div className="social-icon-2 w-embed">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <Link href="https://in.linkedin.com/company/registerkaro" target="_blank" className="social-icons1_link w-inline-block">
                  <div className="social-icon-2 w-embed">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <Link href="https://www.youtube.com/@registerkaro7245" target="_blank" className="social-icons1_link w-inline-block">
                  <div className="social-icon-2 w-embed">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
